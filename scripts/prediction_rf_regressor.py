# prediction_rf_regressor.py
"""
Grade Prediction using Random Forest Regressor
...
def on_click(b):
    with output:
        ...
        print(f"  (Based on historical avg: {hist_avg:.2f}, subjects: {hist_count} - Random Forest model)")
