...
def on_click(b):
    with output:
        ...
        print(f"\nRisk prediction in '{mat}' for semester {sem_futuro}: {pred_label}")
        print(f"  (Probability of this category: {prob_max:.1f}% - Based on historical avg: {hist_avg:.2f}, subjects: {hist_count})")
